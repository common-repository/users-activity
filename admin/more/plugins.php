...
?>
<style>
	.wow-plugin-action-buttons {
	text-align:right;
}
.wow-plugin-action-buttons li {
...
<form id="plugin-filter">
	<div class="wrap about-wrap wow-icons">        
		<p style="padding-bottom: 5px;margin-bottom:30px;"><span class="dashicons dashicons-megaphone"></span>&nbsp;&nbsp;<?php _e( 'Several plugins below are free and you can install them. Hope, they are useful. Enjoy it!', 'users-activity' ); ?></p>
